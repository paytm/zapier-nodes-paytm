    ...
    inputFields: [
      {
        ...
        helpText: 'Enter the subscription ID shared by Paytm after successful mandate registration.',
        type: 'string',
        required: false,
        placeholder: '1xxxxxxxxxx0',
      },
    ],
    perform,
    outputFields: [
      ...
      { key: 'lastOrderCreationDate', label: 'Last order creation date', type: 'datetime' },
    ],
    sample: {
      id: 'SUBS12345',
      subsId: 'SUBS12345',
