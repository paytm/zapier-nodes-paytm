...
const operations = [
  ...
  { mod: require('../src/searches/fetchRefundList'), key: 'fetch_all_refund', requiredInputs: ['startDate', 'endDate'] },
  ...
  { mod: require('../src/searches/settlementTxnListByDate'), key: 'fetch_all_settlements', requiredInputs: ['settlementStartTime', 'settlementEndTime'] },
  { mod: require('../src/searches/settlementBillList'), key: 'fetch_settlement_details', requiredInputs: ['settlementStartTime', 'settlementEndTime'] },
